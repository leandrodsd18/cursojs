...
function intializeGame () {
    ...
    updateTitle()
    //Limpa o tabuleiro (quando necessario), e add o eventos de click
...
//Verifica se existem tres regiões iguais e devolve as regiões
function getWinRegions() {
  ...
  //Desabilita uma região do tabuleiro para q não seja mais clicavel
  ...
  function handleBoardClick(ev){
    //Obtém o índice da região clicada
